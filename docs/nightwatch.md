...
> **Deprecated (2026-09-22).** Nightwatch and Daywatch are deprecated and
> replaced by fleet supervision
> ([design](specs/2026-07-26-fleet-supervision-design.md)). They do not run
> with the pty-holder transport: a watch mode and the holder are refused
> together
> ([gate spec](specs/2026-09-22-nightwatch-deprecation-holder-gate-design.md)).
> A holder port is deferred to
> [#907](https://github.com/cheapsteak/tbd/issues/907).
